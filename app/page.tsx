...
export default function Home() {
  ...
  const filtered=useMemo(()=>notices.filter(n=>(group==='전체'||n.group===group)&&(!showSaved||saved.includes(n.id))&&(!reviewOnly||n.reviewReason)&&(`${n.org} ${n.title} ${n.tag} ${n.audience}`).toLowerCase().includes(query.toLowerCase())),[notices,query,group,saved,showSaved,reviewOnly]);
