...
type CollectionSummary = { discovered:number; inserted:number; updated:number; unchanged:number; review:number };
...
export default function Home() {
  ...
  const [checks,setChecks]=useState<SourceCheck[]>([]); const [syncing,setSyncing]=useState(false); const [collection,setCollection]=useState<CollectionSummary|null>(null);
  useEffect(()=>{
